...
df.test <- subset(df.mciad, select = c("Med_ID", "Subtype", "OM_BMI", "OM_BMI_log", "ID_Hispanic", "ID_Race_Black", "CDX_Diabetes", "Diabetes", "CDX_Hypertension", "Age", "Sex", "CDX_Cog", "Ratio.of.Hippocampal.SUVR.to.Neocortical.SUVR", "ID_Hispanic", "ID_Race_Black", "AB_pos", "ID_Education", "X01_MRI_Scanner", "Ratio.of.Hippocampal.SUVR.to.Neocortical.SUVR")) # create a subsetted data frame containing only what variables I need
...
## 1: BMI
```{r viol1}
ggplot(df.test, aes(x = Subtype, y = OM_BMI)) +
...
## 2: Age
```{r viol2}
ggplot(df.test, aes(x = Subtype, y = Age)) + 
  geom_violin(aes(fill = Subtype), alpha = 0.5, draw_quantiles = c(0.25, 0.5, 0.75)) +
...
``` {r chisq}
set.seed(1001)
chisq.test(df.test$ID_Hispanic, df.test$Subtype, correct = FALSE, p = rep(1/length(df.mciad$Subtype), length(df.mciad$Subtype)), simulate.p.value = TRUE, B = 1000)

chisq.test(df.test$ID_Race_Black, df.test$Subtype, correct = FALSE, p = rep(1/length(df.mciad$Subtype), length(df.mciad$Subtype)), simulate.p.value = TRUE, B = 1000)
...
# create models
m.diabetes <- multinom(data = df.test, Subtype ~ CDX_Diabetes + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.hypertension <- multinom(data = df.test, Subtype ~ CDX_Hypertension + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.BMI <- multinom(data = df.test, Subtype ~ OM_BMI + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.AB_pos <- multinom(data = df.test, Subtype ~ AB_pos + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.combined <- multinom(data = df.test, Subtype ~ OM_BMI + CDX_Hypertension + CDX_Diabetes + AB_pos + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.interaction <- multinom(data = df.test, Subtype ~  CDX_Diabetes*OM_BMI + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)
```
#### Diabetes
```{r multinom1.2}
set.seed(0001)
...
set.seed(011)
summary(m.AB_pos) 
predict(m.AB_pos, df.test, type = "prob") 
cm <- table(predict(m.AB_pos), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
```{r multinom1.4}
summary(m.combined) 
predict(m.combined, df.test, type = "prob") 
cm <- table(predict(m.combined), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
predict(m.interaction, df.test, type = "prob") 
cm <- table(predict(m.interaction), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
m.diabetes2 <- multinom(data = df.test, Subtype ~ CDX_Diabetes + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.hypertension2 <- multinom(data = df.test, Subtype ~ CDX_Hypertension + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.BMI2 <- multinom(data = df.test, Subtype ~ OM_BMI + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.AB_pos2 <- multinom(data = df.test, Subtype ~ AB_pos + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.combined2 <- multinom(data = df.test, Subtype ~ OM_BMI + CDX_Hypertension + CDX_Diabetes + AB_pos + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.interaction2 <- multinom(data = df.test, Subtype ~  CDX_Diabetes*OM_BMI + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)
```
#### Diabetes
```{r multinom2.2}
set.seed(0001)
...
set.seed(011)
summary(m.AB_pos2) 
predict(m.AB_pos2, df.test, type = "prob") 
cm <- table(predict(m.AB_pos2), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
set.seed(011)
summary(m.combined2) 
predict(m.combined2, df.test, type = "prob") 
cm <- table(predict(m.combined2), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
predict(m.interaction2, df.test, type = "prob") 
cm <- table(predict(m.interaction2), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
```{r multinom3}
set.seed(0001)
df.test$Subtype <- relevel(df.test$Subtype, ref = "hippocampal sparing")
```
### comparing models
```{r multinom3.1.2}
# create models
...
m.diabetes3 <- multinom(data = df.test, Subtype ~ CDX_Diabetes + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.hypertension3 <- multinom(data = df.test, Subtype ~ CDX_Hypertension + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.BMI3 <- multinom(data = df.test, Subtype ~ OM_BMI + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.AB_pos3 <- multinom(data = df.test, Subtype ~ AB_pos + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.combined3 <- multinom(data = df.test, Subtype ~ OM_BMI + CDX_Hypertension + CDX_Diabetes + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)

m.interaction3 <- multinom(data = df.test, Subtype ~  CDX_Diabetes*OM_BMI + Age + Sex + ID_Hispanic + ID_Race_Black + ID_Education)
```
#### Diabetes
```{r multinom3.2}
set.seed(0001)
summary(m.diabetes3) 
predict(m.diabetes3, df.test, type = "prob") 
cm <- table(predict(m.diabetes3), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
```{r multinom3.3}
summary(m.BMI3) 
predict(m.BMI3, df.test, type = "prob") 
cm <- table(predict(m.BMI3), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
predict(m.hypertension3, df.test, type = "prob") 
cm <- table(predict(m.hypertension3), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
set.seed(011)
summary(m.combined3) 
predict(m.combined3, df.test, type = "prob") 
cm <- table(predict(m.combined3), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
set.seed(011)
summary(m.AB_pos3) 
predict(m.AB_pos3, df.test, type = "prob") 
cm <- table(predict(m.AB_pos3), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
...
predict(m.interaction3, df.test, type = "prob") 
cm <- table(predict(m.interaction3), df.test$Subtype); cm
1-sum(diag(cm))/sum(cm)
